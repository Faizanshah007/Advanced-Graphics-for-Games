...
void  OGLRenderer::SetShaderLight(const Light *const l[]) {

	Vector3 pos[4] = { l[0]->GetPosition(),l[1]->GetPosition(),l[2]->GetPosition(),l[3]->GetPosition() };
	Vector4 col[4] = { l[0]->GetColour(),l[1]->GetColour(),l[2]->GetColour(),l[3]->GetColour() };
	float	r[4]   = { l[0]->GetRadius(),l[1]->GetRadius(),l[2]->GetRadius(),l[3]->GetRadius() };
	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(),
		"lightPos"), 4, (float*)pos);

	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(),
		"lightColour"), 4, (float*)col);
